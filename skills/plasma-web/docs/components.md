...
Этот файл описывает компонентную модель Salute Plasma Web в формате, удобном для LLM. Агент должен использовать эти компоненты и props при генерации UI-кода.
